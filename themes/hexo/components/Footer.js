...
const Footer = ({ title }) => {
  ...
  return (
    ...
    >
      ...
      <i className='fas fa-copyright' /> {`${copyrightDate}`} <span><i className='mx-1 animate-pulse fas fa-heart'/> <a href={BLOG.LINK} className='underline font-bold  dark:text-gray-300 '>{BLOG.AUTHOR}</a><i className='mx-1 animate-pulse fas fa-heart'/><a href="https://icp.gov.moe/?keyword=20240085" target="_blank">萌ICP备20240085号.</a><br/>
