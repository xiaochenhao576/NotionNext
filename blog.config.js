...
const BLOG = {
  ...
  GREETING_WORDS: process.env.NEXT_PUBLIC_GREETING_WORDS || 'Welcome to OFPEP Offical Website!!',

  CUSTOM_MENU: process.env.NEXT_PUBLIC_CUSTOM_MENU || false, // 支持Menu 类型，从3.12.0版本起，各主题将逐步支持灵活的二级菜单配置，替代了原来的Page类型，此配置是试验功能、默认关闭。

  AUTHOR: process.env.NEXT_PUBLIC_AUTHOR || '欧耶熊猫人', // 您的昵称 例如 tangly1024
  BIO: process.env.NEXT_PUBLIC_BIO || '我是个SABI!', // 作者简介
  LINK: process.env.NEXT_PUBLIC_LINK || 'https://ofpepchinese.eu.org', // 网站地址
  KEYWORDS: process.env.NEXT_PUBLIC_KEYWORD || 'OFPEP, FNF', // 网站关键词 英文逗号隔开
  // 社交链接，不需要可留空白，例如 CONTACT_WEIBO:''
  CONTACT_EMAIL: process.env.NEXT_PUBLIC_CONTACT_EMAIL || 'pandaman@ofpepchinese.eu.org', // 邮箱地址 例如mail@tangly1024.com
  CONTACT_EMAIL2: process.env.NEXT_PUBLIC_CONTACT_EMAIL2 || 'pandaman_reserve@ofpepchinese.eu.org',
  ...
  POSTS_SHARE_SERVICES: process.env.NEXT_PUBLIC_POST_SHARE_SERVICES || 'wechat,qq,email', // 分享的服務，按顺序显示,逗号隔开
  ...
  TITLE: process.env.NEXT_PUBLIC_TITLE || 'OFPEP Blog', // 站点标题 ，被notion中的页面标题覆盖；此处请勿留空白，否则服务器无法编译
  HOME_BANNER_IMAGE:
